...
List<UserModel> users = [
  UserModel(
    socialMediaName: '@TruongVan',
    realName: 'Trưởng',
    profileImageUrl:
        'https://media.istockphoto.com/photos/pretty-young-smiling-girl-in-glasses-taking-a-selfie-picture-id940441670?k=20&m=940441670&s=612x612&w=0&h=r3jnbqf84yXOPe_P6fgYc8nG3DrPGwdxsJZfmW8qAgA=',
    welcomeImageUrl: 'assets/images/selfies/person2.jpg',
    profession: 'Developer',
    following: 2041,
    followers: 302,
    images: [
      'https://media.istockphoto.com/photos/closeup-self-portrait-of-smiling-young-multiethnic-female-friends-picture-id1209000983?k=20&m=1209000983&s=612x612&w=0&h=SYAfHiGjAq9X3Q1aOkCxfdDyGmb0M4goocvidSN3EJI=',
      'https://media.istockphoto.com/photos/selfie-mania-close-up-of-confident-brunette-girl-with-beaming-smile-picture-id926680898?k=20&m=926680898&s=612x612&w=0&h=3Hulw3ubxnhE0A_uwIQTBQf8RcRVBLyptRSevarBLGc=',
  ...
  UserModel(
    ...
    realName: 'Alexandry',
    profileImageUrl:
        'https://media.istockphoto.com/photos/perfect-selfie-picture-id1139664574?k=20&m=1139664574&s=612x612&w=0&h=dY5Fi5dS_vn3LPOEh9ab2nPSEZv0STuW3gazzNG23JY=',
    welcomeImageUrl: 'assets/images/selfies/person1.jpg',
    profession: 'Photographer',
    following: 641,
    followers: 232,
    images: [
      'https://media.istockphoto.com/photos/best-friends-concept-human-taking-a-selfie-with-dog-picture-id1024311010?k=20&m=1024311010&s=612x612&w=0&h=pL7uMs37XkBlcQGLRt3X3VlZrOS4dQ0ZC8RSqvoZ61w=',
      'https://media.istockphoto.com/photos/cheerful-friends-making-selfie-underwater-in-pool-picture-id934251666?k=20&m=934251666&s=612x612&w=0&h=POrLJUK_MeGTNFlfIP-gW94DM6LSIXqSbm1BKUYT7XE=',
